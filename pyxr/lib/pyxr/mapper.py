...
class Mapper(object):
    """ """
    def __init__(self, file_list, npt_x, npt_y, binning=None, roi=None, 
        ...
        # This assumes collection in a typical line-by-line fashion, for raster, spiral, snake etc. will need special treatment
        ...
        composite_shape = (frame_y*npt_y, frame_x*npt_x)
